...
library(evobiR)
Lorenz=function(chrx, fichierIP, fichiercontrol){
  #creation of the Lorenz function with x argument
  
  subtabIP=subset(fichierIP,fichierIP[,1]== chrx)
  subtabC=subset(fichiercontrol,fichiercontrol[,1] == chrx)
...
Lorenz("chrIV",dataPDR1[["IPdata"]],dataPDR1[["controlData"]])
